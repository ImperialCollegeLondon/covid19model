...
if len(sys.argv) != 3:
    print("Usage : extract-reg-opencovid2ICLcsv.py <opencovid csv file> <maille_code to extract>")
    print("   Will read opencovid csv file, extract maille_code data and output them in maille_code.csv with columns needed by base.r")
    sys.exit(1)
...
# TODO…
popreg = { "REG-93" : 5059473 }

def dt_to_dec(dt):
    """Convert a datetime to decimal year.
    Thanks to https://github.com/ImperialCollegeLondon/covid19model/blob/master/Python/src/util.py
    """
...
# notre intérêt est sur la colonne décès, on supprime donc les lignes où cette valeur n'est pas connue
