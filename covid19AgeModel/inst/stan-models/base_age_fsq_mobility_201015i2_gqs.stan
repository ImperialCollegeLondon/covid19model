        ...
        )
    {
        ...
        for (t in (N0+1):N2)
        {
            ...
            if(r_in(t, wkend_idx_local) == 1)
            {
                ...
                {
                    E_casesByAge[t] = tmp_row_vector_A_with_children_impact_intv * cntct_elementary_school_reopening_weekends_local;
            ...
            else
            {
                ...
                {
                    E_casesByAge[t] = tmp_row_vector_A_with_children_impact_intv * cntct_elementary_school_reopening_weekdays_local;
                    E_casesByAge[t, 1:A_CHILD] *= impact_intv_children_effect;
                    E_casesByAge[t, (A_CHILD+1):A] .*= impact_intv[t,(A_CHILD+1):A];
                }
                // counterfactual scenario schools remain closed
        ...
        )
    {
        ...
        for(t in 1:N2)
        {
            ...
            if(r_in(t, wkend_idx_local) == 1)
            {
                ...
                {
                    RtByAge[t,:] = tmp_row_vector_A_with_children_impact_intv * cntct_elementary_school_reopening_weekends_local;
            ...
            else
            {
                ...
                {
                    RtByAge[t,:] = tmp_row_vector_A_with_children_impact_intv * cntct_elementary_school_reopening_weekdays_local;
                    RtByAge[t, 1:A_CHILD] *= impact_intv_children_effect;
                    RtByAge[t, (A_CHILD+1):A] .*= impact_intv[t,(A_CHILD+1):A];
                }
                else if(SCHOOL_STATUS_local[t] == 1 && t>=elt_reopening_index_local)
        ...
        )
    {
        ...
        for (t in (N0+1):N2)
        {
            ...
            if(r_in(t, wkend_idx_local) == 1)
            {
                ...
                {
                    lambdaByAge[t,:] = tmp_row_vector_A_with_children_impact_intv * cntct_elementary_school_reopening_weekends_local;
            ...
            else
            {
                ...
                {
                    lambdaByAge[t,:] = tmp_row_vector_A_with_children_impact_intv * cntct_elementary_school_reopening_weekdays_local;
                    lambdaByAge[t, 1:A_CHILD] *= impact_intv_children_effect;
                    lambdaByAge[t, (A_CHILD+1):A] .*= impact_intv[t,(A_CHILD+1):A];
                }
                else if(SCHOOL_STATUS_local[t] == 1 && t>=elt_reopening_index_local)
...
generated quantities
{
    ...
    // school effect, if conterfactual scenario set to the forecast value, either use impact_intv_children_effect
