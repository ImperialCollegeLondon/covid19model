functions {
        ...
        )
    {
        ...
        impact_intv = covariates_local[1] +
            beta[1] * covariates_local[2] +
            (beta[2] + upswing_rdeff_local) * covariates_local[3];
        ...
        )
    {
        ...
        for (t in (N0+1):N2)
        {
            ...
            // ceiling on contacts between young
            if(t > DIP_TIME_local){
              for(a in AGE_YOUNG){
                for(b in AGE_YOUNG){
                  {
                    row_vector[2] contact_young_weekends = [cntct_weekends_mean_local[a, b] * impact_intv[t,a] * impact_intv[t,b], max_young_contact] ;
                    row_vector[2] contact_young_weekdays = [cntct_weekdays_mean_local[a, b] * impact_intv[t,a] * impact_intv[t,b], max_young_contact] ;
                    cntct_weekends_mean_local_sens[a, b] = min( contact_young_weekends ) / (impact_intv[t,a] * impact_intv[t,b]);
                    cntct_weekdays_mean_local_sens[a, b] = min( contact_young_weekdays ) / (impact_intv[t,a] * impact_intv[t,b]);
                  }
                }
              }
            }
