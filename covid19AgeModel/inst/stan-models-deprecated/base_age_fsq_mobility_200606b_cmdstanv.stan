functions {
        ...
        )
  {
    ...
    impact_intv = exp( log_rho0 + beta * covariates_local );
...
data {
  ...
  matrix[N2,A] covariates[M]; // predictors for fsq contacts by age
  // data by age
...
parameters {
  ...
  real beta; // a single regression coefficient for time varying multipliers on contacts
...
generated quantities {
  ...
  {
    matrix[N2,A] tmp;
    matrix[N2,A] impact_intv = country_impact(R0[m],
                                               beta,
                                               N2,
                                               A,
                                               avg_cntct[m],
