...
model {
  ...
  logit_ifr_age_mult[1] ~ normal(0, 0.004471018);   // sd <- 0.1; acor1 <- 0.999; sd_noi <- sqrt( (1-acor1*acor1)*(sd*sd) )
  logit_ifr_age_mult[2:A_PARS] ~ normal(0.999*logit_ifr_age_mult[1:(A_PARS-1)], 0.004471018);
