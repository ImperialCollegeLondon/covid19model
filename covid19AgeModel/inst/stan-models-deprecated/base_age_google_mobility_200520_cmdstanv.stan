                          ...
                          )
  {
    ...
    for(m_slice in 1:M_slice) {
      ...
      if(map_country[m,1] == 1){
        ...
        lpmf += neg_binomial_2_lpmf(deaths_slice[m_slice, epidemicStart[m]:(dataByAgestart[index_country_slice])] | E_deaths[epidemicStart[m]:(dataByAgestart[index_country_slice])], phi );
