        ...
        for(t in 1:N2)
        {
          ...
          if(r_in(t, wkend_idx_local) == 1)
          {
            if(SCHOOL_STATUS_local[t] == 0){
              ...
              RtByAge[t,:] = ( (impact_intv[t,:] .* RtByAge[t,:]) * (cntct_school_closure_weekends_local') ) .* impact_intv[t,:];
            }
          }
          else
          {
             if(SCHOOL_STATUS_local[t] == 0){
              RtByAge[t,:] = ( (impact_intv[t,:] .* RtByAge[t,:]) * (cntct_weekdays_mean_local') ) .* impact_intv[t,:];
               ...
               RtByAge[t,:] = ( (impact_intv[t,:] .* RtByAge[t,:]) * (cntct_school_closure_weekdays_local') ) .* impact_intv[t,:];
             }
          }
        ...
        for (t in (N0+1):N2)
        {
            ...
            if(r_in(t, wkend_idx_local) == 1)
            {
              ...
              if(SCHOOL_STATUS_local[t] == 0){
                ...
                lambdaByAge[t] = tmp_row_vector_A * cntct_school_closure_weekends_local;
              }
            ...
            else
            {
              if(SCHOOL_STATUS_local[t] == 0){
                ...
                lambdaByAge[t] = tmp_row_vector_A * cntct_school_closure_weekdays_local;
              }
            }
           ...
           if(r_in(t, wkend_idx_local) == 1)
            {
              ...
              if(SCHOOL_STATUS_local[t] == 0){
                ...
                tmp_flow = rep_matrix(tmp_row_vector_A', A) .* cntct_school_closure_weekends_local;
              }
            ...
            else
            {
              if(SCHOOL_STATUS_local[t] == 0){
                ...
                tmp_flow = rep_matrix(tmp_row_vector_A', A) .* cntct_school_closure_weekdays_local;
              }
            }
