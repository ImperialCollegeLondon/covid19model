...
model {
  ...
  target += exponential_lpdf( hyper_log_ifr_age_rnde_mid1 | .05);
  target += exponential_lpdf( hyper_log_ifr_age_rnde_mid2 | .05);
  target += exponential_lpdf( hyper_log_ifr_age_rnde_old | .05);
  ...
  target += normal_lpdf(upswing_timeeff_reduced[1,:] | 0, 0.03);
  target += normal_lpdf( to_array_1d(upswing_timeeff_reduced[2:N_IMP,:]) | to_array_1d(upswing_timeeff_reduced[1:(N_IMP-1),:]), 0.03);
  target += exponential_lpdf( hyper_timeeff_shift_mid1 | .05);
  target += exponential_lpdf( hyper_timeeff_shift_mid2 | .05);
  target += exponential_lpdf( hyper_timeeff_shift_old | .05);
