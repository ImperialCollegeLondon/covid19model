        ...
        for (t in (N0+1):N2)
        {
            ...
            if(t > DIP_TIME_local){
              for(a in AGE_YOUNG){
                for(b in AGE_YOUNG){
                  {
                    row_vector[2] contact_young_weekends = [cntct_weekends_mean_local[a, b], max_young_contact] ;
                    row_vector[2] contact_young_weekdays = [cntct_weekdays_mean_local[a, b], max_young_contact] ;
                    cntct_weekends_mean_local_sens[a, b] = min( contact_young_weekends );
                    cntct_weekdays_mean_local_sens[a, b] = min( contact_young_weekdays );
                  }
                }
              }
            }
