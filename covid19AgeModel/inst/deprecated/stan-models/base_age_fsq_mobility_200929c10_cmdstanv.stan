functions {
        ...
        )
    {
        ...
        // age shift over time
        impact_intv += rep_matrix(timeeff_shift_age, N2);
...
parameters {
  ...
  real timeeff_shift_age_reduced;
  real<lower=0> sd_timeeff_shift_age_reduced;
...
transformed parameters {
  ...
  row_vector[A] timeeff_shift_age = append_col( append_col( rep_row_vector(0., 4), rep_row_vector(timeeff_shift_age_reduced, 4)), rep_row_vector(0., 10));
...
model {
  ...
  phi ~ normal(0,5);
  R0 ~ lognormal(1.1, 0.2); // qlnorm(c(0.025,0.5,0.975), 1.1, 0.2) = 2.029942 3.004166 4.445947
  ...
  timeeff_shift_age_reduced ~ normal(0,sd_timeeff_shift_age_reduced);
  sd_timeeff_shift_age_reduced ~ exponential(10);
