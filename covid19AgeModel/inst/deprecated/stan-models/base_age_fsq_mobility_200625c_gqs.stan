functions {
      ...
      )
  {
    ...
    impact_intv += rep_matrix( weekly_effect_local, A);
...
data {
  ...
  int<lower=1> W; // number of weeks for weekly autoregressive effects
  ...
  int<lower=1, upper=W> week_index[M,N2];
