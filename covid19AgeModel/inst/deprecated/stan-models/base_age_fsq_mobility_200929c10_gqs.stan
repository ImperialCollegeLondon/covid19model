...
generated quantities
{
    ...
    row_vector[A] timeeff_shift_age;
    matrix[N2,A] impact_intv;
    ...
    timeeff_shift_age = append_col( append_col( rep_row_vector(0., 4), rep_row_vector(timeeff_shift_age_reduced, 4)), rep_row_vector(0., 10));
    ...
    // generate expected cases by age + expected deaths by age
    {
        ...
        impact_intv =
            country_impact( rndeff_before_rebound[m],
