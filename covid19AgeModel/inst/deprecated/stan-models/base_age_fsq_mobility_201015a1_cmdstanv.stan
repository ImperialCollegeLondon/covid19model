...
model {
  ...
  hyper_log_ifr_age_rnde_mid1 ~ exponential(.1);
  hyper_log_ifr_age_rnde_mid2 ~ exponential(.1);
  hyper_log_ifr_age_rnde_old ~ exponential(.1);
  ...
  hyper_timeeff_shift_mid1 ~ exponential(.1);
  hyper_timeeff_shift_mid2 ~ exponential(.1);
  hyper_timeeff_shift_old ~ exponential(.1);
