...
data {
  ...
  row_vector<upper=0>[A] hyperpara_ifr_age_lnmu;  // hyper-parameters for probability of death in age band a log normal mean
  row_vector<lower=0>[A] hyperpara_ifr_age_lnsd;  // hyper-parameters for probability of death in age band a log normal sd
...
transformed data {
  ...
  row_vector<upper=0>[A] log_ifr_age_base;
  ...
  log_ifr_age_base = hyperpara_ifr_age_lnmu;
}
...
model {
  ...
  sd_log_ifr_age_rnde_mid1 ~ exponential(5);
  sd_log_ifr_age_rnde_mid2 ~ exponential(5);
