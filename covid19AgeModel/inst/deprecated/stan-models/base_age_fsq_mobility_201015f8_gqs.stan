                ...
                if(SCHOOL_STATUS_local[t] == 0 && t<elementary_school_reopening_idx_local)
                {
                    contacts_ByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * (cntct_weekends_mean_local')[:,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * (cntct_weekends_mean_local')[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * (cntct_weekends_mean_local')[(A_CHILD+1):A,(A_CHILD+1):A]) .* tmp_row_vector_A[(A_CHILD+1):A]
                            );
                }
                else if(SCHOOL_STATUS_local[t] == 0 && t>=elementary_school_reopening_idx_local)
                {
                    contacts_ByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * elt_school_intv_effect * (cntct_elementary_school_reopening_weekends_local')[:,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * elt_school_intv_effect * (cntct_elementary_school_reopening_weekends_local')[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * (cntct_elementary_school_reopening_weekends_local')[(A_CHILD+1):A,(A_CHILD+1):A]) .* tmp_row_vector_A[(A_CHILD+1):A]
                            );
                }
                else if(SCHOOL_STATUS_local[t] == 1 && t>=elt_reopening_index_local)
                {
                    contacts_ByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * (cntct_elementary_school_remains_closed_weekends_local')[:,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * (cntct_elementary_school_remains_closed_weekends_local')[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * (cntct_elementary_school_remains_closed_weekends_local')[(A_CHILD+1):A,(A_CHILD+1):A]) .* tmp_row_vector_A[(A_CHILD+1):A]
                            );
                }
                else
                {
                    contacts_ByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * (cntct_school_closure_weekends_local')[:,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * (cntct_school_closure_weekends_local')[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * (cntct_school_closure_weekends_local')[(A_CHILD+1):A,(A_CHILD+1):A]) .* tmp_row_vector_A[(A_CHILD+1):A]
                            );
                }
            }
            else
                ...
                if(SCHOOL_STATUS_local[t] == 0 && t<elementary_school_reopening_idx_local)
                {
                    contacts_ByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * (cntct_weekdays_mean_local')[:,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * (cntct_weekdays_mean_local')[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * (cntct_weekdays_mean_local')[(A_CHILD+1):A,(A_CHILD+1):A]) .* tmp_row_vector_A[(A_CHILD+1):A]
                            );
                }
                else if(SCHOOL_STATUS_local[t] == 0 && t>=elementary_school_reopening_idx_local)
                {
                    contacts_ByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * elt_school_intv_effect * (cntct_elementary_school_reopening_weekdays_local')[:,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * elt_school_intv_effect * (cntct_elementary_school_reopening_weekdays_local')[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * (cntct_elementary_school_reopening_weekdays_local')[(A_CHILD+1):A,(A_CHILD+1):A]) .* tmp_row_vector_A[(A_CHILD+1):A]
                            );
                }
                else if(SCHOOL_STATUS_local[t] == 1 && t>=elt_reopening_index_local)
                {
                    contacts_ByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * (cntct_elementary_school_remains_closed_weekdays_local')[:,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * (cntct_elementary_school_remains_closed_weekdays_local')[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * (cntct_elementary_school_remains_closed_weekdays_local')[(A_CHILD+1):A,(A_CHILD+1):A]) .* tmp_row_vector_A[(A_CHILD+1):A]
                            );
                }
                else
                {
                    contacts_ByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * (cntct_school_closure_weekdays_local')[:,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * (cntct_school_closure_weekdays_local')[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * (cntct_school_closure_weekdays_local')[(A_CHILD+1):A,(A_CHILD+1):A]) .* tmp_row_vector_A[(A_CHILD+1):A]
                            );
                }
            }
        }
...
generated quantities
{
    ...
    matrix[M,A] timeeff_shift_age_null;
    matrix[N2,A] impact_intv;
    matrix[N2,A] impact_intv_counter;
    matrix<lower=0>[N2,A] E_casesByAge;
    matrix<lower=0>[N2,A] E_casesByAge_counter;
    matrix<lower=0>[N2,A] E_effcasesByAge;
    matrix<lower=0>[N2,A] E_effcasesByAge_counter;
    ...
    matrix<lower=0>[N2,A] RtByAge_counter;
    ...
    timeeff_shift_age_null = rep_matrix(0., M, A);
