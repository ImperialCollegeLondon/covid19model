        ...
        for (t in (N0+1):N2)
        {
            ...
            if(r_in(t, wkend_idx_local) == 1)
            {
                ...
                else if(SCHOOL_STATUS_local[t] == 0 && t>elementary_school_reopening_idx_local)
                {
                    E_casesByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * cntct_elementary_school_reopening_weekends_local[,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * cntct_elementary_school_reopening_weekends_local[1:A_CHILD,(A_CHILD+1):A] +
            ...
            else
            {
                ...
                else if(SCHOOL_STATUS_local[t] == 0 && t>elementary_school_reopening_idx_local)
                {
                    E_casesByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * cntct_elementary_school_reopening_weekdays_local[,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * cntct_elementary_school_reopening_weekdays_local[1:A_CHILD,(A_CHILD+1):A] +
        ...
        )
    {
        ...
        for (t in full_flows_Monday_idx_local:(full_flows_Monday_idx_local+n_days-1))
        {
            ...
            if(r_in(t, wkend_idx_local) == 1)
            {
                ...
                {
                    tmp_flow = append_col( rep_matrix(tmp_row_vector_A_no_impact_intv', A_CHILD), rep_matrix(tmp_row_vector_A', A-A_CHILD) ) .* cntct_elementary_school_reopening_weekends_local;
                }
                else
                {
            ...
            else
            {
                ...
                {
                    tmp_flow = append_col( rep_matrix(tmp_row_vector_A_no_impact_intv', A_CHILD), rep_matrix(tmp_row_vector_A', A-A_CHILD) ) .* cntct_elementary_school_reopening_weekdays_local;
                }
                else
                {
...
data {
  ...
  matrix[A,A] cntct_elementary_school_reopening_weekdays[M]; // contact matrix for school reopening in forecast period
  matrix[A,A] cntct_elementary_school_reopening_weekends[M]; // contact matrix for school reopening in forecast period
  //	priors
