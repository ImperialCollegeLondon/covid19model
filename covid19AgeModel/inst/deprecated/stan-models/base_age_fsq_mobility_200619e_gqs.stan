      ...
      for (t in (N0+1):N2)
      {
        ...
        //E_casesByAge[m][t,:] = tmp_row_vector_A * (
          ...
          if (t >= week_start_index[1]){
            ...
            tmp_flow .*= rep_matrix(append_col(exp(log_relsusceptibility_age), rep_row_vector(1., 2)),A);
...
generated quantities
{
        ...
        // generate R_ta
    {
        ...
        RtByAge = prop_susceptibleByAge .* rep_matrix( append_col(exp(log_relsusceptibility_age), rep_row_vector(1., 2)), N2);
        for(t in 1:N2)
        {
