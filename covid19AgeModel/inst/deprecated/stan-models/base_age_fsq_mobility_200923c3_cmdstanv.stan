functions {
    ...
    matrix country_impact(
        ...
        row_vector upswing_rnde_age_local,
        ...
        )
    {
        ...
        impact_intv = (beta[2] + upswing_rdeff_local + rep_matrix(upswing_rnde_age_local, N2)) .* covariates_local[3];
...
parameters {
  ...
  vector[M] upswing_age_rnde_mid1;
  vector[M] upswing_age_rnde_mid2;
  real<lower=0> sd_upswing_age_rnde_mid1;
  real<lower=0> sd_upswing_age_rnde_mid2;
...
transformed parameters {
  ...
  matrix[M,A] upswing_rnde_age = append_col( append_col( append_col( rep_matrix(0., M, 4),rep_matrix(upswing_age_rnde_mid1, 3)), 
                                  rep_matrix(upswing_age_rnde_mid2, 3)), rep_matrix(0., M, 8) );
}
...
model {
  ...
  upswing_age_rnde_mid1 ~ normal(0, sd_upswing_age_rnde_mid1);
  sd_upswing_age_rnde_mid1 ~ exponential(10);
  upswing_age_rnde_mid2 ~ normal(0, sd_upswing_age_rnde_mid2);
  sd_upswing_age_rnde_mid2 ~ exponential(10);
