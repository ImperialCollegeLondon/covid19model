functions {
   ...
   /*
        ...
        )
    {
        ...
        E_casesByAge[1:(input_N2-7), ] = input_E_casesByAge[1:(input_N2-7), ];
        
        for (t in (input_N2-7+1):N2)
        {
...
parameters {
  ...
  matrix<lower=0>[input_N2,A] input_E_casesByAge;
}
