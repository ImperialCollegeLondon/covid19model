...
parameters {
  ...
  vector[M] timeeff_shift_young2;
  real<lower=0> sd_timeeff_shift_young2;
  vector[M] timeeff_shift_mid1;
  real<lower=0> sd_timeeff_shift_mid1;
  vector[M] timeeff_shift_mid2;
  real<lower=0> sd_timeeff_shift_mid2;
    ...
    append_col(
        append_col(
            append_col(
                append_col(
                    rep_matrix(0., M, 4),
                    rep_matrix(timeeff_shift_young2, 3)
                ),
            rep_matrix(timeeff_shift_mid1, 3)
            ),
          rep_matrix(timeeff_shift_mid2, 3)
          ),
      rep_matrix(0., M, 5)
      );
}
...
model {
  ...
  timeeff_shift_young2 ~ normal(0,sd_timeeff_shift_young2);
  sd_timeeff_shift_young2 ~ exponential(10);  
  timeeff_shift_mid1 ~ normal(0,sd_timeeff_shift_mid1);
  sd_timeeff_shift_mid1 ~ exponential(10);
  timeeff_shift_mid2 ~ normal(0,sd_timeeff_shift_mid2);
  sd_timeeff_shift_mid2 ~ exponential(10);
