...
parameters {
  ...
  row_vector[3] log_relsusceptibility_age_reduced;
...
transformed parameters {
  row_vector[A] log_relsusceptibility_age =
    append_col(
        append_col(
          append_col(
            log_relsusceptibility_age_reduced[ { 1, 1 } ],
            log_relsusceptibility_age_reduced[ { 2, 2 } ]),
            rep_row_vector(0., 9)
            ),
        log_relsusceptibility_age_reduced[ { 3,3,3,3,3 } ]
        );
...
model {
  ...
  target += normal_lpdf( log_relsusceptibility_age_reduced[1] | -0.6833129, 0.242431);//citation: Viner et al JAMAPediatrics 
  target += normal_lpdf( log_relsusceptibility_age_reduced[2] | -0.353706, 0.2245081);//citation: Viner et al JAMAPediatrics 
  target += normal_lpdf( log_relsusceptibility_age_reduced[3] | 0.3828269, 0.1638433);//citation: Zhang et al Science
