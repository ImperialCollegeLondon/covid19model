  ...
  int r_in(int pos,int[] pos_var) {
   ...
   /*
    ...
    matrix country_impact(
        ...
        int N2,
        int age_band_shielded_idx,
        int N_no_impact_intv_idx,
        int A,
        int A_CHILD,
        int[] AGE_CHILD,
        int[] no_impact_intv_idx,
        int COVARIATES_N,
        matrix[] covariates_local,
        row_vector timeeff_shift_age_local,
        ...
        )
    {
        ...
        impact_intv = (beta[2] + upswing_rdeff_local + rep_matrix(timeeff_shift_age_local, N2)) .* covariates_local[3];
        ...
        impact_intv[age_band_shielded_idx:N2,no_impact_intv_idx] = rep_matrix(1.0, N2-age_band_shielded_idx+1, N_no_impact_intv_idx);
    ...
    matrix country_EcasesByAge(
      ...
      int age_band_shielded_idx_local,
      int N2,
      vector SCHOOL_STATUS_local,
      int A,
      int A_CHILD,
      int N_no_impact_intv_idx,
      int N_impact_intv_idx,
      int[] no_impact_intv_idx,
      int[] impact_intv_idx,
      int SI_CUT,
      int[] wkend_idx_local,
      ...
      matrix cntct_weekends_mean_shielded_age_band_local,
      matrix cntct_weekdays_mean_shielded_age_band_local,
      matrix cntct_school_closure_weekends_shielded_age_band_local,
      matrix cntct_school_closure_weekdays_shielded_age_band_local,
      matrix cntct_elementary_school_reopening_weekends_shielded_age_band_local,
      matrix cntct_elementary_school_reopening_weekdays_shielded_age_band_local,
      ...
      )
      {
        ...
        row_vector[A_CHILD] tmp_row_vector_A_CHILD;
        row_vector[N_no_impact_intv_idx] tmp_row_vector_N_no_impact_intv_idx;
        row_vector[N_impact_intv_idx] tmp_row_vector_N_impact_intv_idx;
        ...
        for (t in (N0+1):N2)
        {
          ...
          if(t <= age_band_shielded_idx_local){
            ...
            if(r_in(t, wkend_idx_local) == 1)
            {
              if(SCHOOL_STATUS_local[t] == 0 && t<=elementary_school_reopening_idx_local)
              {
                tmp_row_vector_A_CHILD = tmp_row_vector_A_no_impact_intv * cntct_weekends_mean_shielded_age_band_local[,1:A_CHILD];
                tmp_row_vector_N_no_impact_intv_idx =  tmp_row_vector_A_no_impact_intv * cntct_weekends_mean_shielded_age_band_local[,no_impact_intv_idx];
                tmp_row_vector_N_impact_intv_idx = tmp_row_vector_A_no_impact_intv[1:A_CHILD] * cntct_weekends_mean_shielded_age_band_local[1:A_CHILD,impact_intv_idx] +
                (tmp_row_vector_A[impact_intv_idx] * cntct_weekends_mean_shielded_age_band_local[impact_intv_idx, impact_intv_idx]) .* impact_intv[t,impact_intv_idx ]+
                (tmp_row_vector_A_no_impact_intv[no_impact_intv_idx] * cntct_weekends_mean_shielded_age_band_local[no_impact_intv_idx, impact_intv_idx]);
                E_casesByAge[t,1:A_CHILD] = tmp_row_vector_A_CHILD;
                E_casesByAge[t,no_impact_intv_idx] = tmp_row_vector_N_no_impact_intv_idx;
                E_casesByAge[t,impact_intv_idx] = tmp_row_vector_N_impact_intv_idx;
                // E_casesByAge[t] =
                //   append_col(
                  //     tmp_row_vector_A_no_impact_intv * cntct_weekends_mean_local[,1:A_CHILD],
                  //     tmp_row_vector_A_no_impact_intv[1:A_CHILD] * cntct_weekends_mean_local[1:A_CHILD,(A_CHILD+1):A] +
              ...
              {
                tmp_row_vector_A_CHILD = tmp_row_vector_A_no_impact_intv * elt_school_intv_effect * cntct_elementary_school_reopening_weekends_shielded_age_band_local[,1:A_CHILD];
                tmp_row_vector_N_no_impact_intv_idx =  tmp_row_vector_A_no_impact_intv * cntct_elementary_school_reopening_weekends_shielded_age_band_local[,no_impact_intv_idx];
                tmp_row_vector_N_impact_intv_idx = tmp_row_vector_A_no_impact_intv[1:A_CHILD] * elt_school_intv_effect * cntct_elementary_school_reopening_weekends_shielded_age_band_local[1:A_CHILD,impact_intv_idx] +
                (tmp_row_vector_A[impact_intv_idx] * cntct_elementary_school_reopening_weekends_shielded_age_band_local[impact_intv_idx, impact_intv_idx]) .* impact_intv[t,impact_intv_idx ]+
                (tmp_row_vector_A_no_impact_intv[no_impact_intv_idx] * cntct_elementary_school_reopening_weekends_shielded_age_band_local[no_impact_intv_idx, impact_intv_idx]);
                E_casesByAge[t,1:A_CHILD] = tmp_row_vector_A_CHILD;
                E_casesByAge[t,no_impact_intv_idx] = tmp_row_vector_N_no_impact_intv_idx;
                E_casesByAge[t,impact_intv_idx] = tmp_row_vector_N_impact_intv_idx;
                //  E_casesByAge[t] =
              ...
              {
                tmp_row_vector_A_CHILD = tmp_row_vector_A_no_impact_intv * cntct_school_closure_weekends_shielded_age_band_local[,1:A_CHILD];
                tmp_row_vector_N_no_impact_intv_idx =  tmp_row_vector_A_no_impact_intv * cntct_school_closure_weekends_shielded_age_band_local[,no_impact_intv_idx];
                tmp_row_vector_N_impact_intv_idx = tmp_row_vector_A_no_impact_intv[1:A_CHILD] * cntct_school_closure_weekends_shielded_age_band_local[1:A_CHILD,impact_intv_idx] +
                (tmp_row_vector_A[impact_intv_idx] * cntct_school_closure_weekends_shielded_age_band_local[impact_intv_idx, impact_intv_idx]) .* impact_intv[t,impact_intv_idx ]+
                (tmp_row_vector_A_no_impact_intv[no_impact_intv_idx] * cntct_school_closure_weekends_shielded_age_band_local[no_impact_intv_idx, impact_intv_idx]);
                E_casesByAge[t,1:A_CHILD] = tmp_row_vector_A_CHILD;
                E_casesByAge[t,no_impact_intv_idx] = tmp_row_vector_N_no_impact_intv_idx;
                E_casesByAge[t,impact_intv_idx] = tmp_row_vector_N_impact_intv_idx;
                // E_casesByAge[t] =
            ...
            else
            {
              if(SCHOOL_STATUS_local[t] == 0 && t<=elementary_school_reopening_idx_local)
              {
                tmp_row_vector_A_CHILD = tmp_row_vector_A_no_impact_intv * cntct_weekdays_mean_shielded_age_band_local[,1:A_CHILD];
                tmp_row_vector_N_no_impact_intv_idx =  tmp_row_vector_A_no_impact_intv  * cntct_weekdays_mean_shielded_age_band_local[,no_impact_intv_idx];
                tmp_row_vector_N_impact_intv_idx = tmp_row_vector_A_no_impact_intv[1:A_CHILD] * cntct_weekdays_mean_shielded_age_band_local[1:A_CHILD,impact_intv_idx] +
                (tmp_row_vector_A[impact_intv_idx] * cntct_weekdays_mean_shielded_age_band_local[impact_intv_idx, impact_intv_idx]) .* impact_intv[t,impact_intv_idx ]+
                (tmp_row_vector_A_no_impact_intv[no_impact_intv_idx] * cntct_weekdays_mean_shielded_age_band_local[no_impact_intv_idx, impact_intv_idx]);
                E_casesByAge[t,1:A_CHILD] = tmp_row_vector_A_CHILD;
                E_casesByAge[t,no_impact_intv_idx] = tmp_row_vector_N_no_impact_intv_idx;
                E_casesByAge[t,impact_intv_idx] = tmp_row_vector_N_impact_intv_idx;
                // E_casesByAge[t] =
              ...
              {
                tmp_row_vector_A_CHILD = tmp_row_vector_A_no_impact_intv * elt_school_intv_effect * cntct_elementary_school_reopening_weekdays_shielded_age_band_local[,1:A_CHILD];
                tmp_row_vector_N_no_impact_intv_idx =  tmp_row_vector_A_no_impact_intv * cntct_elementary_school_reopening_weekdays_shielded_age_band_local[,no_impact_intv_idx];
                tmp_row_vector_N_impact_intv_idx = tmp_row_vector_A_no_impact_intv[1:A_CHILD] * elt_school_intv_effect * cntct_elementary_school_reopening_weekdays_shielded_age_band_local[1:A_CHILD,impact_intv_idx] +
                (tmp_row_vector_A[impact_intv_idx] * cntct_elementary_school_reopening_weekdays_shielded_age_band_local[impact_intv_idx, impact_intv_idx]) .* impact_intv[t,impact_intv_idx ]+
                (tmp_row_vector_A_no_impact_intv[no_impact_intv_idx] * cntct_elementary_school_reopening_weekdays_shielded_age_band_local[no_impact_intv_idx, impact_intv_idx]);
                E_casesByAge[t,1:A_CHILD] = tmp_row_vector_A_CHILD;
                E_casesByAge[t,no_impact_intv_idx] = tmp_row_vector_N_no_impact_intv_idx;
                E_casesByAge[t,impact_intv_idx] = tmp_row_vector_N_impact_intv_idx;
                //  E_casesByAge[t] =
              ...
              {
                tmp_row_vector_A_CHILD = tmp_row_vector_A_no_impact_intv * cntct_school_closure_weekdays_shielded_age_band_local[,1:A_CHILD];
                tmp_row_vector_N_no_impact_intv_idx =  tmp_row_vector_A_no_impact_intv * cntct_school_closure_weekdays_shielded_age_band_local[,no_impact_intv_idx];
                tmp_row_vector_N_impact_intv_idx = tmp_row_vector_A_no_impact_intv[1:A_CHILD] * cntct_school_closure_weekdays_shielded_age_band_local[1:A_CHILD,impact_intv_idx] +
                (tmp_row_vector_A[impact_intv_idx] * cntct_school_closure_weekdays_shielded_age_band_local[impact_intv_idx, impact_intv_idx]) .* impact_intv[t,impact_intv_idx ]+
                (tmp_row_vector_A_no_impact_intv[no_impact_intv_idx] * cntct_school_closure_weekdays_shielded_age_band_local[no_impact_intv_idx, impact_intv_idx]);
                E_casesByAge[t,1:A_CHILD] = tmp_row_vector_A_CHILD;
                E_casesByAge[t,no_impact_intv_idx] = tmp_row_vector_N_no_impact_intv_idx;
                E_casesByAge[t,impact_intv_idx] = tmp_row_vector_N_impact_intv_idx;
                //E_casesByAge[t] =
        ...
        if ( t <= age_band_shielded_idx_local){
          ...
          if(r_in(t, wkend_idx_local) == 1)
          {
            if(SCHOOL_STATUS_local[t] == 0 && t<=elementary_school_reopening_idx_local)
            {
              ...
              (tmp_row_vector_A[impact_intv_idx] * (cntct_weekends_mean_shielded_age_band_local')[impact_intv_idx, impact_intv_idx]) .* impact_intv[t,impact_intv_idx ]+
              (tmp_row_vector_A_no_impact_intv[no_impact_intv_idx] * (cntct_weekends_mean_shielded_age_band_local')[no_impact_intv_idx, impact_intv_idx]);
              RtByAge[t,1:A_CHILD] = tmp_row_vector_A_CHILD;
              RtByAge[t,no_impact_intv_idx] = tmp_row_vector_N_no_impact_intv_idx;
              RtByAge[t,impact_intv_idx] = tmp_row_vector_N_impact_intv_idx;
              //RtByAge[t,:] =
              //  append_col(
                //    tmp_row_vector_A_no_impact_intv * (cntct_weekends_mean_local')[:,1:A_CHILD],
                //                  tmp_row_vector_A_no_impact_intv[1:A_CHILD] * (cntct_weekends_mean_local')[1:A_CHILD,(A_CHILD+1):A] +
        ...
        if ( t <= age_band_shielded_idx_local){
          ...
          if(r_in(t, wkend_idx_local) == 1)
          {
            if(SCHOOL_STATUS_local[t] == 0 && t<=elementary_school_reopening_idx_local)
            {
              ...
              (tmp_row_vector_A[impact_intv_idx] * cntct_weekends_mean_shielded_age_band_local[impact_intv_idx, impact_intv_idx]) .* impact_intv[t,impact_intv_idx ]+
              (tmp_row_vector_A_no_impact_intv[no_impact_intv_idx] * cntct_weekends_mean_shielded_age_band_local[no_impact_intv_idx, impact_intv_idx]);
              lambdaByAge[t,1:A_CHILD] = tmp_row_vector_A_CHILD;
              lambdaByAge[t,no_impact_intv_idx] = tmp_row_vector_N_no_impact_intv_idx;
              lambdaByAge[t,impact_intv_idx] = tmp_row_vector_N_impact_intv_idx;
      ...
      for (t in full_flows_Monday_idx_local:(full_flows_Monday_idx_local+n_days-1))
      {
        ...
        if ( t <= age_band_shielded_idx_local){
          ...
          if(r_in(t, wkend_idx_local) == 1)
          {
            if(SCHOOL_STATUS_local[t] == 0 && t<=elementary_school_reopening_idx_local)
            {
              tmp_matrix_A_A[,1:A_CHILD] =  rep_matrix(tmp_row_vector_A_no_impact_intv', A_CHILD);
              tmp_matrix_A_A[,impact_intv_idx] =  rep_matrix(tmp_row_vector_A', N_impact_intv_idx);
              tmp_matrix_A_A[,no_impact_intv_idx] =  rep_matrix(tmp_row_vector_A_no_impact_intv', N_no_impact_intv_idx);
              tmp_flow = tmp_matrix_A_A .*  cntct_weekends_mean_shielded_age_band_local;
              //tmp_flow = append_col( rep_matrix(tmp_row_vector_A_no_impact_intv', A_CHILD), rep_matrix(tmp_row_vector_A', A-A_CHILD) ) .* cntct_weekends_mean_local;
            }
            else if(SCHOOL_STATUS_local[t] == 0 && t>elementary_school_reopening_idx_local)
            {
              tmp_matrix_A_A[,1:A_CHILD] =  rep_matrix(elt_school_intv_effect * tmp_row_vector_A_no_impact_intv', A_CHILD);
              tmp_matrix_A_A[,impact_intv_idx] =  rep_matrix(tmp_row_vector_A', N_impact_intv_idx);
              tmp_matrix_A_A[,no_impact_intv_idx] =  rep_matrix(tmp_row_vector_A_no_impact_intv', N_no_impact_intv_idx);
              tmp_flow = tmp_matrix_A_A .* cntct_elementary_school_reopening_weekends_shielded_age_band_local;
              //tmp_flow = append_col( rep_matrix(elt_school_intv_effect * tmp_row_vector_A_no_impact_intv', A_CHILD), rep_matrix(tmp_row_vector_A', A-A_CHILD) ) .* cntct_elementary_school_reopening_weekends_local;
            }
            else
            {
              ...
              tmp_matrix_A_A[,impact_intv_idx] =  rep_matrix(tmp_row_vector_A', N_impact_intv_idx);
              tmp_matrix_A_A[,no_impact_intv_idx] =  rep_matrix(tmp_row_vector_A_no_impact_intv', N_no_impact_intv_idx);
              tmp_flow = tmp_matrix_A_A  .* cntct_school_closure_weekends_shielded_age_band_local;
              //tmp_flow = append_col( rep_matrix(tmp_row_vector_A_no_impact_intv', A_CHILD), rep_matrix(tmp_row_vector_A', A-A_CHILD) ) .* cntct_school_closure_weekends_local;
            }
          }
          else
          {
            if(SCHOOL_STATUS_local[t] == 0 && t<=elementary_school_reopening_idx_local)
            {
              ...
              tmp_matrix_A_A[,impact_intv_idx] =  rep_matrix(tmp_row_vector_A', N_impact_intv_idx);
              tmp_matrix_A_A[,no_impact_intv_idx] =  rep_matrix(tmp_row_vector_A_no_impact_intv', N_no_impact_intv_idx);
              tmp_flow = tmp_matrix_A_A .*  cntct_weekdays_mean_shielded_age_band_local;
            ...
            {         
              ...
              tmp_matrix_A_A[,impact_intv_idx] =  rep_matrix(tmp_row_vector_A', N_impact_intv_idx);
              tmp_matrix_A_A[,no_impact_intv_idx] =  rep_matrix(tmp_row_vector_A_no_impact_intv', N_no_impact_intv_idx);
              tmp_flow = tmp_matrix_A_A .* cntct_elementary_school_reopening_weekdays_shielded_age_band_local;
            ...
            else
            {
              ...
              tmp_matrix_A_A[,impact_intv_idx] =  rep_matrix(tmp_row_vector_A', N_impact_intv_idx);
              tmp_matrix_A_A[,no_impact_intv_idx] =  rep_matrix(tmp_row_vector_A_no_impact_intv', N_no_impact_intv_idx);
              tmp_flow = tmp_matrix_A_A  .* cntct_school_closure_weekdays_shielded_age_band_local;
        ...
        if ( t <= age_band_shielded_idx_local){
          ...
          tmp_matrix_A_A[1:A_CHILD,] =  rep_matrix(rep_row_vector(1.0, A), A_CHILD);
          tmp_matrix_A_A[impact_intv_idx,] =  rep_matrix(impact_intv[t,], N_impact_intv_idx);
          tmp_matrix_A_A[no_impact_intv_idx,] =  rep_matrix(rep_row_vector(1.0, A), N_no_impact_intv_idx);
          tmp_flow .*= tmp_matrix_A_A;
        }
    ...
    )
    {
      ...
      for (week in 1:N_WEEKS_FULL_FLOWS_local)
      {
        ...
        country_EflowsByHighDimAge_AggregateDays(
          ...
          age_band_shielded_idx_local,
          SCHOOL_STATUS_local,
          A,
          A_CHILD,
          N_no_impact_intv_idx,
          N_impact_intv_idx,
          no_impact_intv_idx,
          impact_intv_idx,
          SI_CUT,
          ...
          cntct_weekends_mean_shielded_age_band_local,
          cntct_weekdays_mean_shielded_age_band_local,
          cntct_school_closure_weekends_shielded_age_band_local,
          cntct_school_closure_weekdays_shielded_age_band_local,
          cntct_elementary_school_reopening_weekends_shielded_age_band_local,
          cntct_elementary_school_reopening_weekdays_shielded_age_band_local,
          rev_serial_interval,
          popByAge_abs_local,
...
data {
  ...
  int<lower=1> age_band_shielded_idx[M];
  ...
  int N_no_impact_intv_idx;
  int no_impact_intv_idx[N_no_impact_intv_idx];
  int N_impact_intv_idx;
  int impact_intv_idx[N_impact_intv_idx];
  ...
  matrix[A,A] cntct_school_closure_weekdays_shielded_age_band[M]; // min cntct_weekdays_mean and contact intensities during outbreak estimated in Zhang et al 
  matrix[A,A] cntct_school_closure_weekends_shielded_age_band[M]; // min cntct_weekends_mean and contact intensities during outbreak estimated in Zhang et al
  ...
  matrix[A,A] cntct_elementary_school_reopening_weekdays_shielded_age_band[M]; // contact matrix for school reopening
  matrix[A,A] cntct_elementary_school_reopening_weekends_shielded_age_band[M]; // contact matrix for school reopening
  //	priors
  ...
  matrix[A,A] cntct_weekdays_mean_shielded_age_band[M];  // mean of prior contact rates between age groups on weekdays (set shielded bands to be 0.5)
  matrix[A,A] cntct_weekends_mean_shielded_age_band[M]; // mean of prior contact rates between age groups on weekends (set shielded bands to be 0.5)
...
parameters {
  ...
  real<lower=0> hyper_timeeff_shift_mid2;
  real<lower=0> hyper_timeeff_shift_old;
  vector<lower=0>[M] timeeff_shift_mid1;
  vector<lower=0>[M] timeeff_shift_mid2;
  vector<lower=0>[M] timeeff_shift_old;
  ...
  append_col(
    append_col(
      append_col(
        ...
        rep_matrix(timeeff_shift_mid2, 4)
        ),
        rep_matrix(timeeff_shift_old, 4)
        );
      ...
      cntct_weekends_mean_shielded_age_band[m],
      cntct_weekdays_mean_shielded_age_band[m],
      cntct_school_closure_weekends_shielded_age_band[m],
      cntct_school_closure_weekdays_shielded_age_band[m],
      cntct_elementary_school_reopening_weekends_shielded_age_band[m],
      cntct_elementary_school_reopening_weekdays_shielded_age_band[m],
      rev_serial_interval,
      popByAge_abs[m,],
      N_init_A,
      init_A
    ...
    lambdaByAge = country_lambdaByAge(// parameters
    rho0,
    log_relsusceptibility_age,
    elt_school_intv_effect,
    impact_intv,
    ...
    reduced_flows =country_EflowsByLowDimAge(// parameters
    rho0,
    elt_school_intv_effect,
    impact_intv,
    E_casesByAge,
    ...
    full_flows = country_EflowsByHighDimAge(// parameters
    rho0,
    elt_school_intv_effect,
    impact_intv,
    E_casesByAge,
