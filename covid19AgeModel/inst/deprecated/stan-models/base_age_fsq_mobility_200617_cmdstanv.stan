functions {
      ...
      )
  {
    ...
    matrix country_EcasesByAge(// parameters
                              ...
                              real sd_log_relsusceptibility_age,
                              // data
                              int N0,
                              int N2,
                              int A,
                              ...
                              )
  {
    ...
    for (t in (N0+1):N2)
    {
      ...
      }
      {
        ...
        E_casesByAge[t] .*= exp( sd_log_relsusceptibility_age * log_relsusceptibility_age );
      }
    }
...
data {
  ...
  int<lower=1, upper=A> node1[A*2-3];
  int<lower=1, upper=A> node2[A*2-3];
}
...
model {
  ...
  log_relsusceptibility_age ~ icar_normal(A, node1, node2);
