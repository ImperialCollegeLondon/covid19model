...
model {
  ...
  hyper_log_ifr_age_rnde_mid1 ~ exponential(.05);
  hyper_log_ifr_age_rnde_mid2 ~ exponential(.05);
  hyper_log_ifr_age_rnde_old ~ exponential(.05);
  log_ifr_age_rnde_mid1 ~ exponential(hyper_log_ifr_age_rnde_mid1);
  log_ifr_age_rnde_mid2 ~ exponential(hyper_log_ifr_age_rnde_mid2);
  log_ifr_age_rnde_old ~ exponential(hyper_log_ifr_age_rnde_old);
  ...
  upswing_timeeff_reduced[2:N_IMP] ~ normal(upswing_timeeff_reduced[1:(N_IMP-1)], 0.025);
  hyper_timeeff_shift_mid1 ~ exponential(.05);
  hyper_timeeff_shift_mid2 ~ exponential(.05);
  hyper_timeeff_shift_old ~ exponential(.05);
  timeeff_shift_mid1 ~ exponential(hyper_timeeff_shift_mid1);
  timeeff_shift_mid2 ~ exponential(hyper_timeeff_shift_mid2);
  timeeff_shift_old ~ exponential(hyper_timeeff_shift_old);
