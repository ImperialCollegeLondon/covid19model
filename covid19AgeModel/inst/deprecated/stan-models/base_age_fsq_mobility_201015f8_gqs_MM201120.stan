functions {
        ...
        )
    {
        ...
        // contact matrix for counterfactual scenarios in which schools reopen without NPIs
        matrix[A,A] cntct_elementary_school_reopening_counterfactual_weekends_local = cntct_elementary_school_reopening_weekends_local;
        matrix[A,A] cntct_elementary_school_reopening_counterfactual_weekdays_local = cntct_elementary_school_reopening_weekdays_local;
        cntct_elementary_school_reopening_counterfactual_weekends_local[1:A_CHILD, 1:A_CHILD] = counterfactual_school_effect * cntct_elementary_school_reopening_weekends_local[1:A_CHILD, 1:A_CHILD];
        cntct_elementary_school_reopening_counterfactual_weekends_local[1:A_CHILD, (A_CHILD +1):A] = elt_school_intv_effect * cntct_elementary_school_reopening_weekends_local[1:A_CHILD, (A_CHILD +1):A];
        cntct_elementary_school_reopening_counterfactual_weekends_local[(A_CHILD +1):A,1:A_CHILD] = elt_school_intv_effect * cntct_elementary_school_reopening_weekends_local[(A_CHILD +1):A,1:A_CHILD];
        cntct_elementary_school_reopening_counterfactual_weekdays_local[1:A_CHILD, 1:A_CHILD] = counterfactual_school_effect * cntct_elementary_school_reopening_weekdays_local[1:A_CHILD, 1:A_CHILD];
        cntct_elementary_school_reopening_counterfactual_weekdays_local[1:A_CHILD, (A_CHILD +1):A] = elt_school_intv_effect * cntct_elementary_school_reopening_weekdays_local[1:A_CHILD, (A_CHILD +1):A];
        cntct_elementary_school_reopening_counterfactual_weekdays_local[(A_CHILD +1):A,1:A_CHILD] = elt_school_intv_effect * cntct_elementary_school_reopening_weekdays_local[(A_CHILD +1):A,1:A_CHILD];
        ...
        for(a in 1:A_CHILD)
        {
            ...
            for(aprime in 1:A)
            {
                cntct_elementary_school_remains_closed_weekends_local[a, aprime] =
                    min([
                        cntct_elementary_school_reopening_weekends_local[a, aprime]*elt_school_intv_effect,
                        cntct_school_closure_weekends_local[a, aprime]
                        ]);
                        
                cntct_elementary_school_remains_closed_weekdays_local[a, aprime] =
                    min([
                        cntct_elementary_school_reopening_weekdays_local[a, aprime]*elt_school_intv_effect,
            ...
            for(aprime in (A_CHILD+1):A)
            {
                cntct_elementary_school_remains_closed_weekends_local[aprime, a] =
                    min([
                        cntct_elementary_school_reopening_weekends_local[aprime, a]*elt_school_intv_effect,
                        cntct_school_closure_weekends_local[aprime, a]
                        ]);
                cntct_elementary_school_remains_closed_weekdays_local[aprime, a] =
                    min([
                        cntct_elementary_school_reopening_weekdays_local[aprime, a]*elt_school_intv_effect,
        ...
        for (t in (N0+1):N2)
        {
            ...
            if(r_in(t, wkend_idx_local) == 1)
            {
                ...
                else if(SCHOOL_STATUS_local[t] == 0 && t>=elementary_school_reopening_idx_local && counterfactual_school_effect < 0)
                {
                    E_casesByAge[t] =
                        append_col(
                ...
                else if(SCHOOL_STATUS_local[t] == 0 && t>=elementary_school_reopening_idx_local && counterfactual_school_effect >= 0)
                {
                    E_casesByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * cntct_elementary_school_reopening_counterfactual_weekends_local[,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * cntct_elementary_school_reopening_counterfactual_weekends_local[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * cntct_elementary_school_reopening_counterfactual_weekends_local[(A_CHILD+1):A,(A_CHILD+1):A]) .* impact_intv[t,(A_CHILD+1):A]
                            );
            ...
            else
            {
                ...
                else if(SCHOOL_STATUS_local[t] == 0 && t>=elementary_school_reopening_idx_local && counterfactual_school_effect >= 0)
                {
                    E_casesByAge[t] =
                        append_col(
                            tmp_row_vector_A_no_impact_intv * cntct_elementary_school_reopening_counterfactual_weekdays_local[,1:A_CHILD],
                            tmp_row_vector_A_no_impact_intv[1:A_CHILD] * cntct_elementary_school_reopening_counterfactual_weekdays_local[1:A_CHILD,(A_CHILD+1):A] +
                                (tmp_row_vector_A[(A_CHILD+1):A] * cntct_elementary_school_reopening_counterfactual_weekdays_local[(A_CHILD+1):A,(A_CHILD+1):A]) .* impact_intv[t,(A_CHILD+1):A]
                            );
        ...
        )
    {
        ...
        for (t in full_flows_Monday_idx_local:(full_flows_Monday_idx_local+n_days-1))
        {
            ...
            if(r_in(t, wkend_idx_local) == 1)
            {
                ...
                {
                    tmp_flow = append_col( rep_matrix(elt_school_intv_effect * tmp_row_vector_A_no_impact_intv', A_CHILD), rep_matrix(tmp_row_vector_A', A-A_CHILD) ) .* cntct_elementary_school_reopening_counterfactual_weekends_local;
                }
                else if(SCHOOL_STATUS_local[t] == 1 && t>=elt_reopening_index_local)
                {
            ...
            else
            {
                ...
                {
                    tmp_flow = append_col( rep_matrix(elt_school_intv_effect * tmp_row_vector_A_no_impact_intv', A_CHILD), rep_matrix(tmp_row_vector_A', A-A_CHILD) ) .* cntct_elementary_school_reopening_counterfactual_weekdays_local;
                }
                else if(SCHOOL_STATUS_local[t] == 1 && t>=elt_reopening_index_local)
                {
