...
ggsave(filename = paste0(outfile.base, "-ifrbyage_fit.pdf"), w = 6, h = 6,dpi=500)
...
ggsave(file = paste0(outfile.base, "-comparison_ifr_prediction_betabinom_lognormal.pdf"), w = 6, h = 6,dpi=500)
