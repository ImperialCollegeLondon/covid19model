...
data <- copy(e_acases_byage_c)
p_newcases <- vector('list',length(plot.pars.basic$regions))

parname <- "e_newcases"
ylab <- 'Age composition of new infections'
...
{
	ggsave(paste0(outfile.base,'-',parname,'_byage', '.png'), g, w = 21, h=29)
}
