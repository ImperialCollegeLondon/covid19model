...
if(length(args_line) > 0) 
{
  ...
  stopifnot(args_line[[21]]=='-ifr_decay_total')
  stopifnot(args_line[[23]]=='-ifr_decay_month_start')
  ...
  args[['ifr_decay_total']] <- as.numeric(args_line[[22]])
  args[['ifr_decay_month_start']] <- args_line[[24]]
} 

## set other args
args$cntct_by <- 5L	
args$file_stanModel <- file.path(pkg.dir, 'stan-models',paste0(args$stanModelFile,'.stan'))
args$file_jhu_death_data_padded <- file.path(pkg.dir,"data","jhu_death_data_padded_201210.rds")
args$file_nyt_death_data_padded <- file.path(pkg.dir,"data","nyt_death_data_padded_201210.rds")
args$file_nyc_death_data_padded <- file.path(pkg.dir,"data","NYC_deaths_201210.csv")
args$file_death_data_by_age <- file.path(pkg.dir,"data","DeathsByAge_US_201210_cured.csv")
...
args$file_fsq_mobility <- file.path(pkg.dir,'data','fsq_visit_data_dec_refresh_201210.csv')
...
args$file_ifr_by_age_prior_Levin_v7 <- file.path(pkg.dir,'data','ifr-by-age-prior_Levin_201117.csv') # lognormal prior from Levin et al. https://www.medrxiv.org/content/10.1101/2020.07.23.20160895v5
...
args$file_cdc_survey <- file.path(pkg.dir, "data", "cdc_survey.csv")
args$file_cross_sectional_national <- file.path(pkg.dir, "data", "cross_sectional_national_survey.csv")
args$file_school_cases <- file.path(pkg.dir,"data","school_cases.csv")
...
if(grepl("fsq_mobility_200729a|fsq_mobility_200729b|fsq_mobility_200729c|fsq_mobility_200730a|fsq_mobility_200730b|fsq_mobility_200730c", args$file_stanModel))
{
...
if(grepl("fsq_mobility_200729d|fsq_mobility_200729e|fsq_mobility_200729f", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_200729g", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
  ...
  args$with_eta2 <- 1
  args$with_biweekly_upswing_time_effect <- 1
  args$fix_beta_baseline <- 1
}
if(grepl("fsq_mobility_200805c|fsq_mobility_200731a|fsq_mobility_200731b|fsq_mobility_200731c", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
  ...
  args$with_upswing_rnde <- 1
  args$with_eta2 <- 1
  args$with_contact_constraint_young <- 1
}
if(grepl("fsq_mobility_200803c", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_200729h|fsq_mobility_200730h", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_200730k", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
  ...
  args$with_biweekly_upswing_time_effect <- 1
  args$with_dip_rnde <- 1
  args$with_estimated_pairwise_mobility_trends <- 1
}
if(grepl("fsq_mobility_200812", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
  ...
  args$with_biweekly_upswing_time_effect <- 1
  args$with_contact_constraint_young <- 1
  args$with_contact_constraint_child_parent <- 1
}
if(grepl("fsq_mobility_200817|fsq_mobility_200819", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
  ...
  args$with_contact_constraint_young <- 1
  args$with_contact_constraint_child_parent <- 1
  args$with_contact_constraint_parent_child <- 1
  args$with_contact_boundaries <- 1
}
if(grepl("fsq_mobility_200821a|fsq_mobility_200821c", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_200821b|fsq_mobility_200821e", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_200923b", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_200923c|fsq_mobility_201009c[5-6]", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_200929c", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_201009c[7-8]", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
	...
	args$with_dip_rnde <- 1
	args$with_smoothed_case_data <- 1
	args$with_upswing_age2039_rnde <- 1
}
if(grepl("fsq_mobility_201009d", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
	...
	args$with_dip_rnde <- 1
	args$with_smoothed_case_data <- 1
	args$with_upswing_age2049_rnde <- 1
}
if(grepl("fsq_mobility_201009e", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
	...
	args$with_dip_rnde <- 1
	args$with_smoothed_case_data <- 1
	args$with_upswing_age2034_rnde <- 1
	args$with_upswing_age3549_rnde <- 1
}
if(grepl("fsq_mobility_201009f", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
	...
	args$with_upswing_age2034_rnde <- 1
	args$with_upswing_age3549_rnde <- 1
	args$with_upswing_age5064_rnde <- 1
}
if(grepl("fsq_mobility_201013c", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
  ...
  args$with_dip_rnde <- 1
  args$with_smoothed_case_data <- 1
  args$with_seroprevalence_data <- 1
}
if(grepl("fsq_mobility_201014", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_201015a", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
	...
	args$with_upswing_expmid2_rnde <- 1
	args$with_upswing_expold_rnde <- 1
}
if(grepl("fsq_mobility_201015b", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_201015c", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_201015d", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_201015e", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_201015f|fsq_mobility_201015h|fsq_mobility_201109f", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_201015g", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
	...
	args$with_smoothed_case_data <- 1
	args$with_upswing_expmid1_rnde <- 1
	args$with_ifr_fixed_decay <- 1
}
if(grepl("fsq_mobility_201015i", args$file_stanModel))
{
	args$with_fsq_mobility <- 1
	args$with_google_mobility <- 0	
	args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_201204a", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(grepl("fsq_mobility_201204b", args$file_stanModel))
{
  args$with_fsq_mobility <- 1
  args$with_google_mobility <- 0	
  args$with_lognormal_prior_on_each_ifr_by_age_band <- 1
...
if(args$with_ifr_fixed_decay){
  processed_data <- stan_data_add_ifr_fixed_decay_rate(processed_data,
                                                            ifr_decay_total = args$ifr_decay_total,
                                                            ifr_decay_month_start = args$ifr_decay_month_start)
}
if(args$with_ifr_var_decay){
  processed_data <- stan_data_add_ifr_var_decay_rate(processed_data,
                                                            ifr_decay_total = args$ifr_decay_total,
                                                            ifr_decay_month_start = args$ifr_decay_month_start)
}
...
if( args$with_contact_intensities_zhang && args$with_EduWeek_data)
{
  ...
  processed_data <- stan_data_add_school_status_EduWeek_with_closure2(
    ...
    default_school_closure_2_date = default_school_closure_2_date
  )    
}
