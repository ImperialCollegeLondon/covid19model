...
args$file_jhu_death_data_padded <- file.path(pkg.dir,"data-v110","jhu_death_data_padded_201030.rds")
args$file_nyt_death_data_padded <- file.path(pkg.dir,"data-v110","nyt_death_data_padded_201030.rds")
args$file_nyc_death_data_padded <- file.path(pkg.dir,"data-v110","NYC_deaths_201030.csv")
args$file_death_data_by_age <- file.path(pkg.dir,"data-v110","DeathsByAge_US_201029.csv")
args$file_ihme_hospitalization <- file.path(pkg.dir,"data-v110","Hospitalization_all_locs.csv")
args$file_states <- file.path(pkg.dir,"data-v110","states.csv")
args$file_weighted_ifr <- file.path(pkg.dir, "data-v110","weighted_ifr.RDS")
args$file_fsq_mobility <- file.path(pkg.dir,'data-v110','fsq_visit_data_nov_refresh_201112.csv')
args$file_grouped <- file.path(pkg.dir,"data-v110","grouped.csv")
args$file_us_population <- file.path(pkg.dir,"data-v110","us_population_withnyc.rds")
args$file_serial_interval <- file.path(pkg.dir,'data-v110','serial_interval.csv')
args$file_covariates <- file.path(pkg.dir,"data-v110","covariates.RDS")
args$file_contact_weekday <- file.path(pkg.dir,'data-v110','polymod.tab.bin_GB_weekday.rda') 
args$file_contact_weekend <- file.path(pkg.dir,'data-v110','polymod.tab.bin_GB_weekend.rda') 
args$file_polymod_data <- file.path(pkg.dir,'data-v110','polymod_data_with_covariates_200623.rds')
args$file_pop_age <- file.path(pkg.dir,'data-v110','popByAge_v200421.csv')
args$file_us_area <- file.path(pkg.dir,"data-v110","us_states_area_measurements.csv")
args$file_ifr_by_age_prior_Verity <- file.path(pkg.dir,'data-v110','ifr-by-age-prior_Verity_200624.csv') # prior with smooth spline on Verity estimates https://www.thelancet.com/journals/laninf/article/PIIS1473-3099(20)30243-7/fulltext
args$file_ifr_by_age_prior_Levin <- file.path(pkg.dir,'data-v110','ifr-by-age-prior_Levin_200904.csv') # lognormal prior from Levin et al. https://www.medrxiv.org/content/10.1101/2020.07.23.20160895v5
args$file_ifr_by_age_prior_Levin_v7 <- file.path(pkg.dir,'data-v110','ifr-by-age-prior_Levin_201117.csv') # lognormal prior from Levin et al. https://www.medrxiv.org/content/10.1101/2020.07.23.20160895v5
args$file_ifr_by_age_prior_BetaBinomial <- file.path(pkg.dir,'data-v110','ifr-by-age-prior_BetaBinomial_200902.csv') # prior estimated with a betabinomial, logit link with gp https://www.medrxiv.org/content/10.1101/2020.09.18.20197376v1
args$file_CI_OR <- file.path(pkg.dir, "data-v110", "CI_OR_age_Zhang.csv")
args$file_region <- file.path(pkg.dir,"data-v110", "usa-regions.csv")
args$file_contact_intensities_outbreak_China <- file.path(pkg.dir, "data-v110", "estimate_contact_intensities_outbreak_China.rds")
args$file_contact_intensities_outbreak_UK <- file.path(pkg.dir, "data-v110", "estimate_contact_intensities_outbreak_UK.rds")
...
args$file_cdc_survey <- file.path(pkg.dir, "data-v110", "cdc_survey.csv")
args$file_cross_sectional_national <- file.path(pkg.dir, "data-v110", "cross_sectional_national_survey.csv")
args$file_school_cases <- file.path(pkg.dir,"data-v110","school_cases.csv")
...
if(grepl("fsq_mobility_201015i|covid19AgeModel_v110", args$file_stanModel))
{
